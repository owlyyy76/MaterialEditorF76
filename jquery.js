					...
					<form action="" method="get">
						<fieldset>
							...
							<div id="jq-compression" class="jq-clearfix">
								<input type="radio" name="name" value="http://code.jquery.com/jquery-1.6.4.min.js" id="jq-production" checked="checked" />
								<a class="jq-radioToggle name jq-checked" href="http://code.jquery.com/jquery-1.6.4.min.js">jquery-1.6.4.min.js</a>
								<label for="jq-production">Production <em>(<strong>31KB</strong>, Minified and Gzipped)</em></label>
								<input type="radio" name="name" value="http://code.jquery.com/jquery-1.6.4.js" id="jq-development" />
								<a class="jq-radioToggle name" href="http://code.jquery.com/jquery-1.6.4.js">jquery-1.6.4.js</a>
							...
							<p class="jq-version"><strong>Current Release:</strong> v1.6.4</p>
						</fieldset>
					</form>
					<script>
